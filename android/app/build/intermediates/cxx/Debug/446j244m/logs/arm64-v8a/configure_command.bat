...
"C:\\Users\\kaif1\\AppData\\Local\\Android\\sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=C:\\flutter_projects\\vaccinationreminder\\android\\app\\build\\intermediates\\cxx\\Debug\\446j244m\\obj\\arm64-v8a" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=C:\\flutter_projects\\vaccinationreminder\\android\\app\\build\\intermediates\\cxx\\Debug\\446j244m\\obj\\arm64-v8a" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BC:\\flutter_projects\\vaccinationreminder\\android\\app\\.cxx\\Debug\\446j244m\\arm64-v8a" ^
  -GNinja ^
  -Wno-dev ^
  --no-warn-unused-cli
